...
file_path = (os.path.dirname(os.path.realpath(__file__))).decode('utf8')

command = raw_input("Unity Sprite Resizer, this will rescale your image(s) and adjust the .meta accordingly for split sprites."
...
mult = float(raw_input("Enter the number you wish to multiply each dimension by (use values <1 for crunching assets):\n"))
