...
#pragma warning restore 0649
  ...
  public void stopScroll() => scroll = false;
  ...
  public void setShiftSpeed(float shiftSpeed) => this.shiftSpeed = shiftSpeed;

  public float getCurrentShiftSpeed() => velocityOverTime.Evaluate(Time.time - startTime);
  ...
  void updateScroll() => transform.position += Vector3.right * getCurrentShiftSpeed() * Time.deltaTime;
  ...
  public void stopChase() => chase = enabled = false;
