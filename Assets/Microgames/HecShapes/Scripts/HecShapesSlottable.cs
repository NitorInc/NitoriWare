...
public class HecShapesSlottable : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.vibration = GetComponent<HecShapesVibrate>();
    ...
    public void OnRelease()
    {
        ...
        {
            this.snapTarget.GetComponentInParent<HecShapesWobble>().Settle();
            this.snap = true;
        }
        else
        {
            vibration.StartVibrate();
        }
