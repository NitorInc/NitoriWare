...
public class DiadefenderBulletController2 : MonoBehaviour {
    ...
    {
        while (TotalBullet > BulletFired) //Shoot only a number of bullet but unable to set spawn timer
        {
            ...
            //https://www.youtube.com/watch?v=WGn1zvLSndk Coroutine script
...
//need a bullet class that is able to change vector with preset bullets