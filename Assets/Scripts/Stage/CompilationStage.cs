...
public class CompilationStage : Stage
{
  ...
  public override bool isMicrogameDetermined(int num) => (num - roundStartIndex < microgamesPerRound);
  ...
  public override int getMicrogameDifficulty(Microgame microgame, int num) => Mathf.Min(roundsCompleted + 1, 3);
  ...
  public override int getCustomSpeed(int microgame, Interruption interruption) => 1 + getRoundSpeedOffset();
