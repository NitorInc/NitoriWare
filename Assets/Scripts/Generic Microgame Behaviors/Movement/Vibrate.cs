...
public class Vibrate : MonoBehaviour
{
  ...
  public void resetOffset() => offset = relativeToStartPosition ? (Vector2)transform.localPosition : Vector2.zero;

  void setOffset(Vector3 position) => offset = (Vector2)position;
  ...
  void resetPosition() => transform.localPosition = new Vector3(0f, 0f, transform.localPosition.z);
