...
public class ObjectPool : MonoBehaviour
{
  ...
  /// </summary>
  /// <returns></returns>
  public float getPoolSize() => pool.Count;
  ...
  /// </summary>
  /// <returns></returns>
  public GameObject getObjectWithoutUnpooling() => getObjectWithoutUnpooling(0);
  ...
  /// <param name="index"></param>
  /// <returns></returns>
  public GameObject getObjectWithoutUnpooling(int index) => pool[index];
