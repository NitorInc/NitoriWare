...
public static class PrefsHelper
{
  ...
  /// </summary>
  /// <returns></returns>
  public static string getPreferredLanguage() => storedPrefs.preferredLanguage;
  ...
  /// <param name="type"></param>
  /// <returns></returns>
  public static float getVolumeRaw(VolumeType type) => storedPrefs.volumes[(int)type];
  ...
  /// </summary>
  /// <returns></returns>
  public static GameProgress getProgress() => (GameProgress)PlayerPrefs.GetInt(ProgressKey, 0);

  /// <summary>
  /// Sets the amount of stages the player has won
  /// </summary>
  /// <param name="progress"></param>
  public static void setProgress(GameProgress progress) => PlayerPrefs.SetInt(ProgressKey, (int)progress);
